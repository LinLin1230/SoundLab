...
* The current version is not yet a complete implementation of all the classic DFT functions.
* It focuses on the conversion between a real signal and a complex spectrum.
*
